...
class Settings(BaseSettings):
    ...
    SPRINKLR_COOKIES : str = Field(default="SPR_STICKINESS=1749550410.741.66.163814|935c7dcb81a00314ea56a3b1f4989107; JSESSIONID=3B51B6933E73CCB1C23A495B5D0E08F9; user.env.type=ENTERPRISE; connect.token=.fKeHtUSEejLsit/ak7CBslxj0czYgRZIlx5c95RVx/8; SPR_AT=bkEzcUdZMm5ITVdSTDNOZmJiREVp; connect.sid=s%3ASu-IbyfoSns9E6gaDloVQHX4Vhjtkkai.CTPDlkD5SuDzm8LXTqFS4agB2YIq20mhFsfzmvly%2BHI; sess-exp-time=Wed, 11 Jun 2025 14:37:43 GMT", description="Sprinklr API cookies for authentication")
    SPRINKLR_REQUEST_AT : str = Field(default="1749551383783", description="Timestamp for the Sprinklr API request")
    SPRINKLR_REQUEST_ID: str = Field(default="space-c033b943-d850-433a-a278-12a66b6f6e1f", description="Unique request ID for Sprinklr API")
    SPRINKLR_CSRF_TOKEN: str = Field(default="bkEzcUdZMm5ITVdSTDNOZmJiREVp", description="CSRF token for Sprinklr API requests")
    SPRINKLR_SENTRY_TRACE: str = Field(default="600358f299c9426bb5973cafbf5982af-a0e11d2e73f2e57b", description="Sentry trace ID for Sprinklr API requests")
